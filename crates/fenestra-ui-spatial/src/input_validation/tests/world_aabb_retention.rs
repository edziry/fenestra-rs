...
use super::world_aabb_support::{aabb, fact};
use super::world_transform_support::{
    SCALE, ScriptedLayoutEngine, VIEWPORT, expect_valid, fixture, limits, logical, output,
    placement, world,
};
...
#[test]
fn world_aabbs_retain_the_complete_predecessor_and_exact_raw_borrows() {
    let paints = vec![
    ...
    let proof = expect_valid(prepare_world_aabbs!(
        &fixture,
        VIEWPORT,
        requested_limits,
        &engine
    ...
    assert_eq!(
        ...
        vec![
            fact(0, aabb(0, 0, logical(20), logical(20))),
            fact(1, aabb(0, logical(10), logical(10), logical(20))),
            fact(2, aabb(logical(1), logical(12), logical(4), logical(16))),
            fact(3, aabb(logical(1), logical(6), logical(11), logical(16))),
        ]
    );
    assert_eq!(
        ...
        vec![fact(
            0,
            aabb(logical(1), logical(12), logical(4), logical(16))
        )]
    );
    assert_eq!(
        proof.paint_world_aabb_facts(),
        vec![
            fact(0, aabb(logical(1), logical(12), logical(4), logical(16))),
            fact(1, aabb(logical(10), logical(30), logical(13), logical(34))),
        ]
    );
    assert_eq!(
        ...
        vec![fact(
            0,
            aabb(-logical(1), logical(11), logical(5), logical(17))
        )]
    );
    assert_eq!(
        ...
        vec![fact(
            0,
            aabb(logical(1), logical(6), logical(3), logical(6))
        )]
    );
    assert_eq!(
    ...
    let bytes = proof
        ...
        .expect("world AABBs retain the exact final P5 token");
