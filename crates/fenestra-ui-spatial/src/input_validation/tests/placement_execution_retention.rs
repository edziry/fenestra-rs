...
use super::placement_execution_support::{
    ScriptedLayoutEngine, VIEWPORT, expect_valid, fixture, logical, output, placement,
};
...
#[test]
fn placement_execution_retains_the_complete_predecessor_and_exact_raw_borrows() {
    let paints = vec![
    ...
    let bytes = proof
        ...
        .expect("execution retains the exact final P5 token");
